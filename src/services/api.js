...
export const getReportPreview = (id) => api.get(`/reports/${id}/preview`);
export const rewriteReport = (id, prompt) => api.post(`/reports/${id}/rewrite`, { prompt });
export const approveReport = (id) => api.post(`/reports/${id}/approve`);
export const rejectReport = (id, reason) => api.post(`/reports/${id}/reject`, { reason });

export const downloadReportUrl = (id) =>
  `${import.meta.env.VITE_API_URL || "https://seo-automation-production-bfb4.up.railway.app/api"}/reports/${id}/download`;
